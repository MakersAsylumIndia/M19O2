...
def create_param(mods, print=print):
  ...
  param.cycle_time=5       #time for a half-cycle in dimensionless time units
  param.vent_time=3        #from beginning of cycle in dimensionless time units
  ...
  param.blowdown_orifice=0.40     # dia mm
  ...
  param.qAs=0.00526  #saturation constant for O2  mol/g (at infinite pressure)
  param.qBs=0.00526  #saturation constant for N2  mol/g (at infinite pressure)
  param.kA=.62
  param.kB=.197
  #For 5A:
